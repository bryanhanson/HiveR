#' Examine (mine) a HivePlotData object and extract information contained
#' within it
#' 
...
#' do.  The user can easily write new options and incorporate them (or send
#' them to me for incorporation).  This function can be called multiple times
...
#' that node. \cr \cr \code{option = "axis <- source.man.sink"} This option
...
#' details about processing .dot files in an agnostic fashion. \cr \cr
#' \code{option = "remove orphans"} removes nodes that have degree zero (no
#' incoming or outgoing edges). \cr \cr \code{option = "remove zero edge"}
...
#' is removed. \cr \cr \code{option = "remove self edge"} removes edges that
